	...
	<script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/sys/common/wms/rulePaHeader/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
                        jp.success(data.msg);
                        window.location = "${ctx}/sys/common/wms/rulePaHeader/form?id=" + data.body.entity.id;
                    } else {
                        jp.bqError(data.msg);
                    }
                })
        ...
        function initCdRulePaDetailTable() {
            $('#cdRulePaDetailTable').bootstrapTable({
                ...
                url: "${ctx}/sys/common/wms/rulePaDetail/data",
        ...
        function saveDetail() {
            ...
            if (detailSubmitCheck()) {
                ...
                jp.post("${ctx}/sys/common/wms/rulePaDetail/save", data, function (data) {
                    if (data.success) {
        ...
        function removeDetail() {
            ...
            jp.confirm('确认要删除吗？删除将不能恢复？', function () {
                jp.get("${ctx}/sys/common/wms/rulePaDetail/deleteAll?ids=" + rowIds, function (data) {
                    if (data.success) {
                        $('#cdRulePaDetailTable').bootstrapTable('refresh');
                        hideTabRight();
                        jp.success(data.msg);
...
<div class="wrapper wrapper-content-my">
    <div class="panel panel-default">
        <div class="panel-body">
            <form:form id="inputForm" modelAttribute="sysWmsRulePaHeader" method="post" class="form-horizontal">
            <form:hidden path="id"/>
                ...
                <tr>
                    ...
                    <td class="width-12">
                        <sys:grid title="选择数据套" url="${ctx}/sys/common/dataSet/grid" cssClass="form-control required"
                                  fieldId="dataSet" fieldName="dataSet" fieldKeyName="code" fieldValue="${sysWmsRulePaHeader.dataSet}"
                                  displayFieldId="dataSetName" displayFieldName="dataSetName" displayFieldKeyName="name" displayFieldValue="${sysWmsRulePaHeader.dataSetName}"
...
<div class="wrapper wrapper-content-my">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div style="width: 100%; height: 600px; padding-left: 10px;">
                <div id="detailToolbar" style="width: 100%; padding: 0 10px 10px 0;">
                    <shiro:hasPermission name="sys:common:wms:rulePa:addDetail">
                        <a class="btn btn-primary btn-sm" id="addDetail" onclick="addDetail()">新增</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="sys:common:wms:rulePa:saveDetail">
                        <a class="btn btn-primary btn-sm" id="saveDetail" onclick="saveDetail()">保存</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="sys:common:wms:rulePa:removeDetail">
                        <a class="btn btn-primary btn-sm" id="removeDetail" onclick="removeDetail()">删除</a>
                    </shiro:hasPermission>
                </div>
                <div id="tab-left">
                            ...
                            <div class="tab-content">
                                <div id="mainRule" class="tab-pane fade in active">
                                    <table class="bq-table">
                                        ...
                                        <tr>
                                            <td class="pad" width="20%">
                                                <sys:grid title="选择源库位" url="${ctx}/sys/common/wms/loc/grid" cssClass="form-control"
                                                          fieldId="" fieldName="" fieldKeyName=""
                                                          displayFieldId="detail_fmLoc" displayFieldName="fmLoc" displayFieldKeyName="locCode"
                                            ...
                                            <td class="pad" width="20%">
                                                <sys:grid title="选择目标库位" url="${ctx}/sys/common/wms/loc/grid" cssClass="form-control"
                                                          fieldId="" fieldName="" fieldKeyName=""
                                                          displayFieldId="detail_toLoc" displayFieldName="toLoc" displayFieldKeyName="locCode"
                                                          fieldLabels="库位编码|库区代码|库区名称" fieldKeys="locCode|zoneCode|zoneName"
                                                          searchLabels="库位编码|库区代码|库区名称" searchKeys="locCode|zoneCode|zoneName"
                                                          queryParams="dataSet" queryParamValues="dataSet"/>
                                            </td>
                                            <td class="pad" width="20%">
                                                <sys:grid title="选择目标库区" url="${ctx}/sys/common/wms/zone/grid" cssClass="form-control"
                                                          fieldId="" fieldName="" fieldKeyName=""
                                                          displayFieldId="detail_toZone" displayFieldName="toZone" displayFieldKeyName="zoneCode"
                                                          fieldLabels="库区代码|库区名称" fieldKeys="zoneCode|zoneName"
                                                          searchLabels="库区代码|库区名称" searchKeys="zoneCode|zoneName"
                                                          queryParams="dataSet" queryParamValues="dataSet"/>
                                            </td>
                                            <td class="pad" width="20%">
                                            </td>

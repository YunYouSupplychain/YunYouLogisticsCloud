...
<head>
    ...
    <%@include file="sysWmsRuleRotationHeaderList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="sysWmsRuleRotationHeader">
                            <table class="table well">
                                ...
                                <tr>
                                    ...
                                    <td class="width-10"><label class="pull-right" title="周转类型">周转类型</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-10"><label class="pull-right" title="批次属性">批次属性</label></td>
                                    <td class="width-15">
                                        <sys:grid title="选择批次属性" url="${ctx}/sys/common/wms/lotHeader/grid" cssClass="form-control"
                                                  fieldId="lotCode" fieldName="lotCode" fieldKeyName="lotCode"
                                                  displayFieldId="lotName" displayFieldName="lotName" displayFieldKeyName="lotName"
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="sys:common:wms:ruleRotation:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:common:wms:ruleRotation:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:common:wms:ruleRotation:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()"> 删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:common:wms:ruleRotation:sync">
            ...
            <!-- 表格 -->
            <table id="sysWmsRuleRotationHeaderTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

            ...
            <div class="panel-body">
                <table class="table well">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <form:input path="checkPerson" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">采购渠道</label></td>
                        <td class="width-15">
                            <form:select path="poChannel" class="form-control m-b">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SMS_PO_CHANNEL')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">门店配送周期(冷藏)</label></td>
                        <td class="width-15">
                            <form:input path="def1" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">门店配送周期(冷冻)</label></td>
                        <td class="width-15">
                ...
                <div class="wrapper wrapper-content-my" style="padding-left: 0px; padding-right: 0px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <div id="contactsInfo" class="tab-pane">
                                <div id="contactsToolbar" style="padding-bottom: 5px;">
                                    <shiro:hasPermission name="sys:common:customer:contacts:add">
                                        <a id="contacts_add" class="btn btn-primary" onclick="addContacts()"> 新增</a>
                                    </shiro:hasPermission>
                                    <shiro:hasPermission name="sys:common:customer:contacts:del">
                                        <a id="contacts_remove" class="btn btn-danger" onclick="delContacts()"> 删除</a>
                                    </shiro:hasPermission>
                                </div>
                                <table id="contactsTable" class="table text-nowrap" data-toolbar="#contactsToolbar">
                                    <thead>
                                    <tr>
                                        <th class="hide"></th>
                                        ...
                                        <th>联系人编码<font color="red">*</font></th>
                                        <th>联系人名称<font color="red">*</font></th>
                                        <th>头衔</th>

        ...
        $(document).ready(function () {
            ...
            validateForm = $("#inputForm").validate({
                submitHandler: function (form) {
                    jp.post("${ctx}/sys/common/tms/outletRelation/save", $('#inputForm').serialize(), function (data) {
                        if (data.success) {
...
<body>
<form:form id="inputForm" modelAttribute="sysTmsOutletRelation" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    <form:hidden path="dataSet"/>
    <form:hidden path="oldParentIds"/>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="width-35">
                ...
                <sys:grid title="网点" url="${ctx}/sys/common/tms/transportObj/grid"
                          fieldId="code" fieldName="code" fieldKeyName="transportObjCode" fieldValue="${sysTmsOutletRelation.code}"
                          displayFieldId="name" displayFieldName="name" displayFieldKeyName="transportObjName" displayFieldValue="${sysTmsOutletRelation.name}"
            ...
            <td class="width-35">
                <sys:treeselect id="parent" name="parent.id" value="${sysTmsOutletRelation.parent.id}"
                                labelName="parent.name" labelValue="${sysTmsOutletRelation.parent.name}"
                                title="父级编号" url="/tms/basic/sysTmsOutletRelation/treeData" extId="${sysTmsOutletRelation.id}"

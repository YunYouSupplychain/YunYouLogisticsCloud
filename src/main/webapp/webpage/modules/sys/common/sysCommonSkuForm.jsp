...
<form:form id="inputForm" modelAttribute="sysCommonSku" class="form-horizontal">
    ...
    <div class="tabs-container">
        ...
        <div class="tab-content">
            ...
            <div id="smsInfo" class="tab-pane fade">
                <table class="table well">
                    <tbody>
                    <tr>
                        <td class="width-10"><label class="pull-right">商品型号</label></td>
                        <td class="width-15">
                            <form:input path="skuModel" htmlEscape="false" class="form-control" maxlength="32"/>
                        </td>
                        ...
                        <td class="width-10"><label class="pull-right">销售单位</label></td>
                        <td class="width-15">
                            <form:input path="salesUnit" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">存储类别</label></td>
                        <td class="width-15">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <form:input path="tareWeight" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">门店订购倍数</label></td>
                        <td class="width-15">
                            <form:input path="storeOrderTimes" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">拆零标识</label></td>
                        <td class="width-15">
                            <form:input path="detachableFlag" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">扣重比例</label></td>
                        <td class="width-15">
                            <form:input path="deductWeightRatio" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="width-10"><label class="pull-right">商品称重类型</label></td>
                        <td class="width-15">
                            <form:select path="skuWeighType" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('weighing_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">称重方式</label></td>
                        <td class="width-15">
                            <form:select path="weighWay" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('weigh_way')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">检疫商品类别</label></td>
                        <td class="width-15">
                            <form:select path="skuCheckType" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SMS_SKU_CHECK_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">是否进口检疫</label></td>
                        <td class="width-15">
                            <form:select path="isIqc" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('is_iqc')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                    </tr>
                    <tr>
                        <td class="width-10"><label class="pull-right">是否冰品</label></td>
                        <td class="width-15">
                            <form:select path="isIces" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SYS_YES_NO')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">箱体积</label></td>
                        <td class="width-15">
                            <form:input path="boxVolume" htmlEscape="false" class="form-control" maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">采购分类</label></td>
                        <td class="width-15">
                            <form:select path="poClass" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('po_class')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">采购类型</label></td>
                        <td class="width-15">
                            <form:select path="purchaseType" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SMS_PO_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                    </tr>
                    <tr>
                        <td class="width-10"><label class="pull-right">采购mop</label></td>
                        <td class="width-15">
                            <form:input path="poOm" htmlEscape="false" class="form-control" maxlength="64" onkeyup="bq.numberValidator(this, 2, 0)"/>
                        </td>
                        <td class="width-10"><label class="pull-right">理论mop</label></td>
                        <td class="width-15">
                            <form:input path="om" htmlEscape="false" class="form-control" maxlength="64" onkeyup="bq.numberValidator(this, 2, 0)"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#supplierInfo" aria-expanded="true">供应商信息</a></li>
                    </ul>
                    <div class="tab-content">
                        <div id="supplierInfo" class="tab-pane fade in active">
                            <div id="supplierToolbar" style="padding: 5px 0;">
                                <shiro:hasPermission name="sys:common:sku:supplier:add">
                                    <a id="supplier_add" class="btn btn-primary" onclick="addSupplier()"> 新增</a>
                                </shiro:hasPermission>
                                <shiro:hasPermission name="sys:common:sku:supplier:del">
                                    <a id="supplier_remove" class="btn btn-danger" onclick="delSupplier()"> 删除</a>
                                </shiro:hasPermission>
                            </div>
                            <table id="skuSupplierTable" class="table table-striped table-bordered table-condensed">
                                <thead>
                                <tr>
                                    <th class="hide"></th>
                                    <th style="width:36px;vertical-align:middle">
                                    ...
                                    <th class="asterisk">供应商代码</th>
                                    <th class="asterisk">供应商名称</th>
                                    <th>是否默认</th>
                                    <th width="10">&nbsp;</th>
                                </tr>
                                </thead>
                                <tbody id="skuSupplierList"></tbody>
                            </table>
                        </div>
                    </div>
                </div>

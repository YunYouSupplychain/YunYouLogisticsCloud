    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (validate.isSuccess) {
                openDisable('#inputForm');
                jp.loading();
                jp.post("${ctx}/sys/common/wms/loc/save", $('#inputForm').bq_serialize(), function (data) {
                    if (data.success) {
...
<body>
<form:form id="inputForm" modelAttribute="sysWmsLoc" method="post" class="form-horizontal">
    <form:hidden path="id"/>
            ...
            <div class="panel-body">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="width-12">
                            <sys:grid title="选择库区" url="${ctx}/sys/common/wms/zone/grid" cssClass="form-control required"
                                      fieldId="zoneCode" fieldName="zoneCode" fieldKeyName="zoneCode" fieldValue="${sysWmsLoc.zoneCode}"
                                      displayFieldId="zoneName" displayFieldName="zoneName" displayFieldKeyName="zoneName" displayFieldValue="${sysWmsLoc.zoneName}"
                    ...
                    <tr>
                        ...
                        <td class="width-12">
                            <sys:grid title="选择数据套" url="${ctx}/sys/common/dataSet/grid" cssClass="form-control required"
                                      fieldId="dataSet" fieldName="dataSet" fieldKeyName="code" fieldValue="${sysWmsLoc.dataSet}"
                                      displayFieldId="dataSetName" displayFieldName="dataSetName" displayFieldKeyName="name" displayFieldValue="${sysWmsLoc.dataSetName}"

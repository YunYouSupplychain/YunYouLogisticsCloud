        ...
        $(document).ready(function () {
            $('#areaTree').jstree({
                'core': {
                    ...
                    'data': {
                        "url": "${ctx}/sys/common/oms/businessServiceScope/treeData?bssId=${sysOmsBusinessServiceScope.id}",
            ...
            validateForm = $("#inputForm").validate({
                submitHandler: function (form) {
                    ...
                    jp.loading();
                    $.post("${ctx}/sys/common/oms/businessServiceScope/save", $('#inputForm').serialize(), function (data) {
                        if (data.success) {
                            jp.success(data.msg);
                        } else {
                            jp.error(data.msg);
...
<body>
<div id="areaTree"></div>
<form:form id="inputForm" modelAttribute="sysOmsBusinessServiceScope" method="post" class="form-horizontal">
    <form:hidden path="id"/>

...
<head>
    ...
    <script type="text/javascript">
        ...
        function generateLoc() {
            ...
            var params = {locCode: $('#locCode').val(), locList: locArray, sumLength: sumLength, dataSet: $('#dataSet').val()};
            $.ajax({
                url: "${ctx}/sys/common/wms/loc/generateLoc",
                type: "post",
        ...
        function save() {
            ...
            jp.loading();
            $.ajax({
                url: "${ctx}/sys/common/wms/loc/confirm",
                type: "post",
...
<div style="width: 100%; height: 100%;">
    ...
    <form:form id="inputForm" modelAttribute="sysWmsLocEntity" method="post" class="form-horizontal">
        <form:hidden path="id"/>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="" width="15%">
                <sys:grid title="选择库区" url="${ctx}/sys/common/wms/zone/grid" cssClass="form-control required" disabled="true"
                          fieldId="zoneCode" fieldName="zoneCode" fieldKeyName="zoneCode" fieldValue="${sysWmsLocEntity.zoneCode}"
                          displayFieldId="zoneName" displayFieldName="zoneName" displayFieldKeyName="zoneName" displayFieldValue="${sysWmsLocEntity.zoneName}"
            ...
            <td class="" width="15%">
                <sys:grid title="选择库区" url="${ctx}/sys/common/wms/loc/grid" cssClass="form-control required"
                          fieldId="" fieldName="" fieldKeyName=""
                          displayFieldId="locCode" displayFieldName="locCode" displayFieldKeyName="locCode" displayFieldValue="${sysWmsLocEntity.locCode}"
                          fieldLabels="库位编码|库位状态|使用类型|库区编码" fieldKeys="locCode|status|locUseType|zoneCode"
                          searchLabels="库位编码" searchKeys="locCode"
                          queryParams="zoneCode|dataSet" queryParamValues="zoneCode|dataSet"/>
            </td>
    ...
    <div id="locDetailToolbar" style="width: 100%; padding: 5px 10px;">
        <a class="btn btn-primary btn-sm" id="remove" onclick="remove()">删除</a>
    </div>

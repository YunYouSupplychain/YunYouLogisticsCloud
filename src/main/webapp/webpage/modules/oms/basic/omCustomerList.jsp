...
<head>
    ...
    <%@include file="omCustomerList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="omCustomerEntity">
                            <table class="table well">
                                <tbody>
                                <tr>
                                    <td class="width-10"><label class="pull-right">客户代码</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-15">
                                        <form:select path="ebcuType" class="form-control m-b">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="basic:omCustomer:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="basic:omCustomer:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="basic:omCustomer:del">
            ...
            <!-- 表格 -->
            <table id="omCustomerTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

...
<head>
    ...
    <%@include file="omSkuClassificationList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="omSkuClassification" class="form">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="oms:basic:skuClassification:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="oms:basic:skuClassification:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="oms:basic:skuClassification:del">

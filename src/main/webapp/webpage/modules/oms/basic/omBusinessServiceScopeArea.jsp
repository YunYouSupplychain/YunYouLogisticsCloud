        ...
        $(document).ready(function () {
            $('#areaTree').jstree({
                'core': {
                    ...
                    'data': {
                        "url": "${ctx}/oms/basic/omBusinessServiceScope/treeData?bssId=${omBusinessServiceScopeEntity.id}",
            ...
            validateForm = $("#inputForm").validate({
                submitHandler: function (form) {
                    ...
                    jp.loading();
                    $.post("${ctx}/oms/basic/omBusinessServiceScope/save", $('#inputForm').serialize(), function (data) {
                        if (data.success) {
                            jp.success(data.msg);
                        } else {
                            jp.error(data.msg);
...
<body>
<div id="areaTree"></div>
<form:form id="inputForm" modelAttribute="omBusinessServiceScopeEntity" method="post" class="form-horizontal">
    <form:hidden path="id"/>

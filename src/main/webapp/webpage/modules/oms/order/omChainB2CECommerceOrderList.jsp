...
<head>
    ...
    <%@include file="omChainB2CECommerceOrderList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title">B2C电商订单列表</h3></div>
        <div class="panel-body">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()"> 删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:audit">
                    <button id="audit" class="btn btn-primary" disabled onclick="audit()"> 审核</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:cancelAudit">
                    <button id="cancelAudit" class="btn btn-primary" disabled onclick="cancelAudit()"> 取消审核</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:createTask">
                    <button id="createTask" class="btn btn-primary" disabled onclick="createTask()"> 生成作业任务</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="order:omChainB2CECommerceOrder:import">
...
<div id="importBox" class="hide">
    <form id="importForm" action="${ctx}/oms/order/omChainB2CECommerceOrder/import" method="post" enctype="multipart/form-data" style="padding-left:20px;text-align:center;"><br/>

...
<head>
    ...
    <%@ include file="omChainDCOrderForm.js" %>
    <style>
...
<form:form id="inputForm" modelAttribute="omChainHeaderEntity" method="post" class="form">
    ...
    <form:hidden path="ownerTaxRate"/>
    <form:hidden path="supplierTaxRate"/>
    <form:hidden path="chainType"/>
    ...
    <div class="tabs-container" style="height: 220px;">
        <ul class="nav nav-tabs">
            ...
            <li class=""><a data-toggle="tab" href="#defInfo" aria-expanded="true">拓展信息</a></li>
        </ul>
        <div class="tab-content">
            <div id="orderInfo" class="tab-pane fade in active">
                <table class="table well">
                    ...
                    <tr>
                        ...
                        <td class="width-10"><label class="pull-right"><font color="red">*</font>订单日期</label></td>
                        <td class="width-15">
                        ...
                        <td class="width-10"><label class="pull-right"><font color="red">*</font>业务订单类型</label></td>
                        <td class="width-15">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择货主" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control required"
                                      fieldId="owner" fieldName="owner" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.owner}"
                                      displayFieldId="ownerName" displayFieldName="ownerName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.ownerName}"
                        ...
                        <td class="width-15">
                            <sys:grid title="选择客户" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control"
                                      fieldId="customer" fieldName="customer" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.customer}"
                                      displayFieldId="customerName" displayFieldName="customerName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.customerName}"
                                      ...
                                      afterSelect="afterSelectCustomer"/>
                        </td>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择供应商" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control"
                                      fieldId="supplierCode" fieldName="supplierCode" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.supplierCode}"
                                      displayFieldId="supplierName" displayFieldName="supplierName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.supplierName}"
                                      ...
                                      afterSelect="afterSelectSupplier"/>
                        </td>
                        <td class="width-10"><label class="pull-right">服务模式</label></td>
                        <td class="width-15">
                            <form:select path="serviceMode" class="form-control">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SYS_SERVICE_MODE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="width-10"><label class="pull-right">有效期至</label></td>
                        <td class="width-15">
                            <div class='input-group form_datetime' id='validityPeriod'>
                                <input type='text' name="validityPeriod" class="form-control"
                                       value="<fmt:formatDate value="${omChainHeaderEntity.validityPeriod}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择业务员" url="${ctx}/oms/basic/omClerk/popData" cssClass="form-control"
                                      fieldId="clerkCode" fieldName="clerkCode" fieldKeyName="clerkCode" fieldValue="${omChainHeaderEntity.clerkCode}"
                                      displayFieldId="clerkName" displayFieldName="clerkName" displayFieldKeyName="clerkName" displayFieldValue="${omChainHeaderEntity.clerkName}"
                        ...
                        <td class="width-15">
                            <form:select path="channel" class="form-control" disabled="true">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SYS_CHANNEL')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
            ...
            <div id="consigneeInfo" class="tab-pane fade">
                <table class="table well">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择收货方" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control"
                                      fieldId="consigneeCode" fieldName="consigneeCode" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.consigneeCode}"
                                      displayFieldId="consigneeName" displayFieldName="consigneeName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.consigneeName}"
                    ...
                    <tr>
                        <td class="width-10"><label class="pull-right">收货人三级地址</label></td>
                        <td class="width-15">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择发货方" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control"
                                      fieldId="shipperCode" fieldName="shipperCode" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.shipperCode}"
                                      displayFieldId="shipperName" displayFieldName="shipperName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.shipperName}"
                        ...
                        <td class="width-15">
                            <div class='input-group form_datetime' id='deliveryDate'>
                                <input type='text' name="deliveryDate" class="form-control"
                                       value="<fmt:formatDate value="${omChainHeaderEntity.deliveryDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:popSelect url="${ctx}/oms/basic/omCustomer/popData" title="选择承运商" cssClass="form-control" allowInput="true" inputSearchKey="codeAndName"
                                           fieldId="carrier" fieldName="carrier" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.carrier}"
                                           displayFieldId="carrierName" displayFieldName="carrierName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.carrierName}"
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <sys:grid title="选择结算方" url="${ctx}/oms/basic/omCustomer/popData" cssClass="form-control"
                                      fieldId="settlement" fieldName="settlement" fieldKeyName="ebcuCustomerNo" fieldValue="${omChainHeaderEntity.settlement}"
                                      displayFieldId="settlementName" displayFieldName="settlementName" displayFieldKeyName="ebcuNameCn" displayFieldValue="${omChainHeaderEntity.settlementName}"
            ...
            <div id="businessInfo" class="tab-pane fade">
                <table class="table well">
                    <tbody>
                    <tr>
                        <td class="width-10"><label class="pull-right">业务人</label></td>
                        <td class="width-15">
            ...
            <div id="defInfo" class="tab-pane fade">
                <table class="table well">
                    <tbody>
                    <tr>
                        ...
                        <td class="width-10"><label class="pull-right">客户品牌</label></td>
                        <td class="width-15">
                            <form:input path="def2" htmlEscape="false" class="form-control " maxlength="64"/>
                        </td>
                        <td class="width-10"><label class="pull-right">客户大类</label></td>
                        <td class="width-15">
                        ...
                        <td class="width-10"><label class="pull-right">客户城市</label></td>
                        <td class="width-15">
                            <form:input path="def4" htmlEscape="false" class="form-control " maxlength="64"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="width-10"><label class="pull-right">客户行业类型</label></td>
                        <td class="width-15">
                            <form:select path="def5" class="form-control m-b">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SYS_INDUSTRY_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">客户范围类型</label></td>
                        <td class="width-15">
                            <form:select path="def6" class="form-control m-b">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SYS_RANGE_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
                        <td class="width-10"><label class="pull-right">入库订单类型</label></td>
                        <td class="width-15">
                            <form:select path="def7" class="form-control ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('SMS_ASN_ORDER_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
    ...
    <div class="tabs-container" style="min-height: 300px;">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">DC订单明细</a></li>
        </ul>
            ...
            <div id="tab-1" class="tab-pane fade in active">
                ...
                <table class="table well text-nowrap" style="min-width: 1500px;">
                    ...
                    <tr>
                        ...
                        <th>任务数量</th>
                        <th class="hide">辅助单位</th>
                        <th class="hide">辅助单位数量</th>
                        <th class="hide">税率</th>
                        <th class="hide">单价</th>
...
<tr id="omChainDetailList{{idx}}">
    <td class="hide">
        ...
        <input id="omChainDetailList{{idx}}_planTaskQty" name="omChainDetailList[{{idx}}].planTaskQty" type="hidden" value="{{row.planTaskQty}}"/>
        <input id="omChainDetailList{{idx}}_chainNo" name="omChainDetailList[{{idx}}].chainNo" type="hidden" value="{{row.chainNo}}"/>
        <input id="omChainDetailList{{idx}}_recVer" name="omChainDetailList[{{idx}}].recVer" type="hidden" value="{{row.recVer}}"/>
    </td>
    <td>
    ...
    <td>
        <sys:grid title="选择商品" url="${ctx}/oms/basic/omItem/orderSkuGrid" cssClass="form-control"
    ...
    <td class="hidden">
        <select id="omChainDetailList{{idx}}_unit" name="omChainDetailList[{{idx}}].unit" data-value="{{row.unit}}" class="form-control m-b" >
    ...
    <td>
        <input id="omChainDetailList{{idx}}_qty" name="omChainDetailList[{{idx}}].qty" type="text" value="{{row.qty}}" class="form-control" />
    </td>
    <td>
    ...
    <td  class="hidden">
        <select id="omChainDetailList{{idx}}_taxRate" name="omChainDetailList[{{idx}}].taxRate" data-value="{{row.taxRate}}" class="form-control m-b" disabled onchange="priceChange({{idx}}, '1')">
    ...
    <td  class="hidden">
        <input id="omChainDetailList{{idx}}_taxPrice" name="omChainDetailList[{{idx}}].taxPrice" type="text" value="{{row.taxPrice}}" class="form-control"  onkeyup="bq.numberValidator(this, 6, 0);priceChange({{idx}}, '1');"/>
    </td>
    <td  class="hidden">

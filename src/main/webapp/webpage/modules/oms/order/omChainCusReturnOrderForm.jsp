...
<html>
<head>
    <title>客户退货订单管理</title>
    <meta name="decorator" content="ani"/>
    <%@ include file="omChainCusReturnOrderForm.js" %>
    <style>
...
<form:form id="inputForm" modelAttribute="omChainHeaderEntity" method="post" class="form">
                    ...
                    <tr>
                        ...
                        <td class="width-15">
                            <form:select path="businessOrderType" class="form-control required" onchange="businessOrderTypeChange()">
                                ...
                                <form:options items="${fns:getDictList('OMS_BUSINESS_ORDER_TYPE_CUS_MRB')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </td>
    ...
    <div class="tabs-container" style="min-height: 300px;">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">客户退货订单明细</a></li>
        </ul>

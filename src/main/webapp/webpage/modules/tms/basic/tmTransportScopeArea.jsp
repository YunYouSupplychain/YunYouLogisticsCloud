        ...
        $(document).ready(function () {
            $('#areaTree').jstree({
                'core': {
                    ...
                    'data': {
                        "url": "${ctx}/tms/basic/tmTransportScope/treeData?headId=${tmTransportScopeEntity.id}",
            ...
            validateForm = $("#inputForm").validate({
                submitHandler: function (form) {
                    ...
                    jp.loading();
                    $.post("${ctx}/tms/basic/tmTransportScope/saveArea", $('#inputForm').serialize(), function (data) {
                        if (data.success) {
                            jp.success(data.msg);
                        } else {
                            jp.error(data.msg);
...
<body>
<div id="areaTree"></div>
<form:form id="inputForm" modelAttribute="tmTransportScopeEntity" method="post" class="form-horizontal">
    <form:hidden path="id"/>

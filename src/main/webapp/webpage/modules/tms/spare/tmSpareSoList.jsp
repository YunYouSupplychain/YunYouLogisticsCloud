...
<head>
    ...
    <%@ include file="tmSpareSoList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">备件出库列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="tmSpareSoEntity" class="form form-horizontal well clearfix">
                            <table class="table table-striped table-bordered table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td style="width:10%;vertical-align:middle;"><label class="pull-right">出库单号：</label></td>
                                    <td style="width:15%;vertical-align:middle;">
                                        <form:input path="spareSoNo" cssClass="form-control" htmlEscape="false"/>
                                    </td>
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="tms:spare:so:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="tms:spare:so:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="tms:spare:so:del">
            ...
            <!-- 表格 -->
            <table id="tmSpareSoTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

...
<html>
<head>
    <title>订单标签路由管理</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8">
    <meta name="decorator" content="ani"/>
    <%@include file="/webpage/include/bootstraptable.jsp" %>
    <script type="text/javascript" src="${ctxStatic}/tms/common.js"></script>
    <%@include file="tmOrderLabelRouteList.js" %>
</head>
<body>
<div class="hidden">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">订单标签路由列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse in">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="tmTransportOrderRouteEntity" class="form">
                            ...
                            <table class="table well">
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <form:input path="labelNo" htmlEscape="false" maxlength="64" class=" form-control"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="width-10"><label class="pull-right">货物当前所在网点</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-10"><label class="pull-right">下一站派送网点</label></td>
                                    <td class="width-15">
                                        <sys:grid title="网点" url="${ctx}/tms/basic/tmTransportObj/grid"
            ...
            <!-- 表格 -->
            <table id="tmOrderLabelRouteTable" data-toolbar="#toolbar" class="text-nowrap"></table>

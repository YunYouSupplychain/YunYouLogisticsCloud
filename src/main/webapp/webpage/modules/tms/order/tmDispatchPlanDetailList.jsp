...
<html>
<head>
    <title>需求调度明细查询</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8">
    <meta name="decorator" content="ani"/>
    <%@ include file="/webpage/include/bootstraptable.jsp" %>
    <%@include file="/webpage/include/treeview.jsp" %>
    <script type="text/javascript" src="${ctxStatic}/tms/common.js"></script>
    <%@include file="tmDispatchPlanDetailList.js" %>
    <style>
        #tmDispatchPlanDetailTable>thead>tr>th,
        #tmDispatchPlanDetailTable>tbody>tr>td {
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">需求调度明细列表</h3>
        </div>
        <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <form id="searchForm">
                        <table class="table table-condensed" style="margin-bottom: 10px">
                            <tr>
                                <td style="width: 8%;"><label class="pull-right">分类</label></td>
                                <td style="width: 10%;">
                                ...
                                <td style="width: 8%;"><label class="pull-right">加油站</label></td>
                                <td style="width: 10%;">
                                ...
                                <td style="width: 8%;"><label class="pull-right">油品</label></td>
                                <td style="width: 10%;">
                                ...
                                <td style="width: 8%;"><label class="pull-right">到达时间从：</label></td>
                                <td style="width: 10%;">
                                ...
                                <td style="width: 8%;"><label class="pull-right">到达时间到：</label></td>
                                <td style="width: 10%;">
            ...
            <!-- 表格 -->
            <table id="tmDispatchPlanDetailTable" class="table-condensed table-striped text-nowrap"></table>
        </div>
    </div>
</div>
</body>

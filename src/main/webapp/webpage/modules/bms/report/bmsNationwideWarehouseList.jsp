...
<html>
<head>
    <title>全国仓网清单管理</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8">
    <meta name="decorator" content="ani"/>
    <%@include file="/webpage/include/bootstraptable.jsp" %>
    <%@include file="bmsNationwideWarehouseList.js" %>
</head>
<body>
<div class="hide">
    <input type="hidden" id="orgId"/>
    <input type="hidden" id="billModule" value="01"/>
</div>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title">全国仓网清单列表</h3></div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="bmsNationwideWarehouseList" class="form">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="bms:report:nationwideWarehouseList:export">
            ...
            <!-- 表格 -->
            <table id="bmsNationwideWarehouseListTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

...
<head>
    ...
    <%@include file="bmsOutboundDataList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">出库数据列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="bmsOutboundDataEntity" class="form">
                            <table class="table well">
                                <tr>
                                    ...
                                    <td class="width-10"><label class="pull-right">发货时间从</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-10"><label class="pull-right">发货时间到</label></td>
                                    <td class="width-15">
                                ...
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <form:select path="orderType" cssClass="form-control input-sm">
                                            <form:option value="" label=""/>
                                            <form:options items="${fns:getDictList('order_type_out_check')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                                        </form:select>
                                    </td>
                                    <td class="width-10"><label class="pull-right">业务订单类型</label></td>
                                    <td class="width-15">
                                        <form:select path="businessType" cssClass="form-control input-sm">
                                            <form:option value="" label=""/>
                                    ...
                                    <td class="width-15">
                                        <form:select path="businessModel" cssClass="form-control input-sm">
                                            <form:option value="" label=""/>
                                ...
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <form:input path="customerCode" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">客户名称</label></td>
                                    <td class="width-15">
                                        <form:input path="customerName" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="business:bmsOutboundData:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()"> 删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsOutboundData:cancelFee">
                    <button id="cancelFee" class="btn btn-primary" disabled onclick="isFee('N')"> 不计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsOutboundData:addFee">
                    <button id="addFee" class="btn btn-primary" disabled onclick="isFee('Y')"> 加入计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsOutboundData:pull">
                    <button id="pull" class="btn btn-primary" onclick="pull()"> 同步数据</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsOutboundData:import">
                    <button id="btnImport" class="btn btn-info"><i class="fa fa-file-excel-o"></i> 导入</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsOutboundData:export">
            ...
            <!-- 表格 -->
            <table id="bmsOutboundDataTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
<!-- 同步数据弹出窗 -->

...
<head>
    ...
    <%@include file="bmsExceptionDataList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">异常数据列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="bmsExceptionDataEntity" class="form">
                            <table class="table well">
                                <tr>
                                    <td class="width-10"><label class="pull-right">发生日期从</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-10"><label class="pull-right">发生日期到</label></td>
                                    <td class="width-15">
                                    ...
                                    <td class="width-15">
                                        <form:select path="exceptionType" class="form-control m-b">
                                            ...
                                            <form:options items="${fns:getDictList('BMS_EXCEPTION_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                                        </form:select>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="width-10"><label class="pull-right">门店配载单号</label></td>
                                    <td class="width-15">
                                        <form:input path="dispatchNo" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">车辆门店单号</label></td>
                                    <td class="width-15">
                                        <form:input path="orderNoA" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">母单号</label></td>
                                    <td class="width-15">
                                        <form:input path="orderNoB" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">子单号</label></td>
                                    <td class="width-15">
                                        <form:input path="orderNoC" htmlEscape="false" maxlength="35" class="form-control"/>
                                    </td>
                                </tr>
                                <tr>
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="business:bmsExceptionData:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()"> 删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsExceptionData:cancelFee">
                    <button id="cancelFee" class="btn btn-primary" disabled onclick="isFee('N')"> 不计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsExceptionData:addFee">
                    <button id="addFee" class="btn btn-primary" disabled onclick="isFee('Y')"> 加入计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsExceptionData:pull">
                    <button id="pull" class="btn btn-primary" onclick="pull()"> 同步数据</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsExceptionData:import">
                    <button id="btnImport" class="btn btn-info"><i class="fa fa-file-excel-o"></i> 导入</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsExceptionData:export">
            ...
            <!-- 表格 -->
            <table id="bmsExceptionDataTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
<!-- 同步数据弹出窗 -->

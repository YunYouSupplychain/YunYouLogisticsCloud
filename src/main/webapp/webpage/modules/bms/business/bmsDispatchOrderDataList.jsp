...
<head>
    ...
    <%@include file="bmsDispatchOrderDataList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">派车单数据列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="bmsDispatchOrderDataEntity" class="form">
                            <table class="table well">
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <div class='input-group form_datetime' id='dispatchDateFm'>
                                            <input type='text' name="dispatchDateFm" class="form-control"/>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                        </div>
                                    </td>
                                    <td class="width-10"><label class="pull-right">派车时间到</label></td>
                                    <td class="width-15">
                                        <div class='input-group form_datetime' id='dispatchDateTo'>
                                            <input type='text' name="dispatchDateTo" class="form-control"/>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <form:input path="carrierCode" htmlEscape="false" maxlength="35" class=" form-control"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">承运商名称</label></td>
                                    <td class="width-15">
                                        <form:input path="carrierName" htmlEscape="false" maxlength="35" class=" form-control"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <form:input path="driverName" htmlEscape="false" maxlength="35" class=" form-control"/>
                                    </td>
                                </tr>
                            </table>
                        </form:form>
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="business:bmsDispatchOrderData:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsDispatchOrderData:cancelFee">
                    <button id="cancelFee" class="btn btn-primary" disabled onclick="isFee('N')">不计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsDispatchOrderData:addFee">
                    <button id="addFee" class="btn btn-primary" disabled onclick="isFee('Y')">加入计费</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsDispatchOrderData:pull">
                    <button id="pull" class="btn btn-primary" onclick="pull()">同步数据</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsDispatchOrderData:import">
                    <button id="btnImport" class="btn btn-info"><i class="fa fa-file-excel-o"></i> 导入</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="business:bmsDispatchOrderData:export">
            ...
            <!-- 表格 -->
            <table id="bmsDispatchOrderDataTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
<!-- 同步数据弹出窗 -->

...
<head>
    ...
    <%@include file="bmsCarrierRouteList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">承运商路由列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="bmsCarrierRouteEntity" cssStyle="form">
                            <table class="table well">
                                <tr>
                                    <td class="width-10"><label class="pull-right">承运商</label></td>
                                    <td class="width-15">
                                        <sys:grid title="承运商" url="${ctx}/bms/basic/bmsCustomer/pop" cssClass="form-control"
                                    ...
                                    <td class="width-15">
                                        <sys:area id="startAreaId" name="startAreaId" value="" labelName="area.name" labelValue=""
                                                  cssClass="form-control " allowSearch="true" showFullName="true"/>
                                    </td>
                                    <td class="width-10"><label class="pull-right">目的地</label></td>
                                    <td class="width-15">
                                        <sys:area id="endAreaId" name="endAreaId" value="" labelName="area.name" labelValue=""
                                                  cssClass="form-control " allowSearch="true" showFullName="true"/>
                                    </td>
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="sys:sysRoute:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:sysRoute:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:sysRoute:del">
                    <button id="remove" class="btn btn-danger" disabled onclick="deleteAll()"> 删除</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="sys:sysRoute:import">
            ...
            <!-- 表格 -->
            <table id="sysRouteTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
<div id="importBox" class="hide">
    <form id="importForm" action="${ctx}/bms/basic/bmsCarrierRoute/import" method="post" enctype="multipart/form-data"

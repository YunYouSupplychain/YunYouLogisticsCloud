...
<head>
    ...
    <%@include file="banQinWmSoPackList.js" %>
</head>
<body>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="banQinWmSoPackEntity" class="form form-horizontal well clearfix">
                            <input id="orgId" name="orgId" type="hidden">
                            <table class="table table-striped table-bordered table-condensed">
                                <tbody>
                                <tr>
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="快递单号：">快递单号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align: middle;">
                                        <form:input path="trackingNo" htmlEscape="false" maxlength="64" class=" form-control"/>
                                    </td>
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="客户订单号：">客户订单号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                        <form:input path="customerOrderNo" htmlEscape="false" maxlength="64" class="form-control"/>
                                    </td>
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="外部单号：">外部单号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="出库单类型：">出库单类型：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align: middle;">
                                    ...
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="供应链订单号：">供应链订单号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                        <form:input path="chainNo" htmlEscape="false" maxlength="64" class="form-control"/>
                                    </td>
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="供应链任务号：">供应链任务号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="打包时间从：">&nbsp;打包时间从：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align: middle;">
                                    ...
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="打包时间到：">&nbsp;打包时间到：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align: middle;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="箱号：">箱号：</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                ...
                                <tr>
                                    <td style="width: 10%; vertical-align: middle;">
                                        <label class="label-item single-overflow pull-right" title="扫描箱号">扫描箱号</label>
                                    </td>
                                    <td style="width: 15%; vertical-align:middle;">
                                        <form:input path="scanCaseNo" htmlEscape="false" maxlength="64" class="form-control"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="outbound:banQinWmSoPack:export">
            ...
            <!-- 表格 -->
            <table id="banQinWmSoPackTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

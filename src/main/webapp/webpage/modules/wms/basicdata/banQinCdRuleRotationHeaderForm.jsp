    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (!isValidate) {
                ...
                jp.loading();
                jp.post("${ctx}/wms/basicdata/banQinCdRuleRotationHeader/save", $('#inputForm').serialize(), function (data) {
                    if (data.success) {
                        jp.success(data.msg);
                        window.location = "${ctx}/wms/basicdata/banQinCdRuleRotationHeader/form?id=" + data.body.entity.id;
                    } else {
                        jp.bqError(data.msg);
                    }
                })
        ...
        function init() {
            if (!$('#id').val()) {
                ...
                $('#lotSelectId').prop('disabled', true);
                $('#lotDeleteId').prop('disabled', true);
            }
        }
        ...
        function initCdRuleRotationDetailTable() {
            $('#cdRuleRotationDetailTable').bootstrapTable({
                ...
                url: "${ctx}/wms/basicdata/banQinCdRuleRotationDetail/data",
        ...
        function saveDetail() {
            ...
            if (detailSubmitCheck()) {
                // 保存前赋值
                beforeSave();
                jp.post("${ctx}/wms/basicdata/banQinCdRuleRotationDetail/save", $('#inputForm1').serialize(), function (data) {
                    if (data.success) {
        ...
        function removeDetail() {
            ...
            jp.confirm('确认要删除吗？删除将不能恢复？', function () {
                jp.get("${ctx}/wms/basicdata/banQinCdRuleRotationDetail/deleteAll?ids=" + rowIds, function (data) {
                    if (data.success) {
                        $('#cdRuleRotationDetailTable').bootstrapTable('refresh');
                        hideTabRight();
                        jp.success(data.msg);
...
<div class="wrapper wrapper-content-my">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form:form id="inputForm" modelAttribute="banQinCdRuleRotationHeaderEntity" method="post" class="form-horizontal">
                <form:hidden path="id"/>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td width="8%"><label class="pull-right"><font color="red">*</font>周转类型</label></td>
                        <td width="12%">
                        ...
                        <td width="8%"><label class="pull-right"><font color="red">*</font>批次属性</label></td>
                        <td width="12%">
                            <sys:popSelect url="${ctx}//wms/basicdata/banQinCdWhLotHeader/grid" title="选择批次属性" cssClass="form-control required"
                                           fieldId="lotCode" fieldName="lotCode" fieldKeyName="lotCode" fieldValue="${banQinCdRuleRotationHeaderEntity.lotCode}" allowInput="true"
                                           displayFieldId="lotName" displayFieldName="lotName" displayFieldKeyName="lotName" displayFieldValue="${banQinCdRuleRotationHeaderEntity.lotName}"
        ...
        <div class="panel-body">
            <div style="width: 100%; padding-left: 10px;">
                <div id="detailToolbar" style="width: 100%; padding: 10px 0px;">
                    <shiro:hasPermission name="basicdata:banQinCdRuleRotationDetail:addDetail">
                        <a class="btn btn-primary" id="addDetail" onclick="addDetail()">新增</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="basicdata:banQinCdRuleRotationDetail:saveDetail">
                        <a class="btn btn-primary" id="saveDetail" onclick="saveDetail()">保存</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="basicdata:banQinCdRuleRotationDetail:removeDetail">
                    ...
                    <form:form id="inputForm1" method="post" class="form-horizontal">
                        ...
                        <table class="bq-table">
                            ...
                            <tr>
                                ...
                                <td width="20%">
                                    <sys:popSelect url="${ctx}/wms/basicdata/banQinCdWhLotDetail/grid" title="选择批次属性标签" cssClass="form-control required"
                                                   fieldId="detail_lotAtt" fieldName="lotAtt" fieldKeyName="lotAtt" fieldValue="" allowInput="true"
                                                   displayFieldId="detail_lotAttName" displayFieldName="lotAttName" displayFieldKeyName="title" displayFieldValue=""
                                                   selectButtonId="lotAttSelectId" deleteButtonId="lotAttDeleteId"
                                                   fieldLabels="批次属性|批次标签" fieldKeys="lotAtt|title"
                                                   searchLabels="批次属性|批次标签" searchKeys="lotAtt|title" inputSearchKey="codeAndName"
                                                   queryParams="lotCode" queryParamValues="lotCode">
                                    </sys:popSelect>
                                </td>
                                <td width="20%">

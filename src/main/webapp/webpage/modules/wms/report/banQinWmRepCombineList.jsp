...
<html>
<head>
    <title>进出存合并数据管理</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8">
    <meta name="decorator" content="ani"/>
    <%@ include file="/webpage/include/bootstraptable.jsp" %>
    <%@include file="banQinWmRepCombineList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">进出存合并报表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="wmRepCombineEntity" class="form">
                            <input id="orgId" name="orgId" type="hidden">
                            <table class="table well">
                                <tbody>
                                <tr>
                                    <td class="width-10">
                                        <label class="pull-right" title="开始时间：">开始时间</label>
                                    </td>
                                    <td class="width-15">
                                        <div class='input-group date' id='tranTimeFm'>
                                            <input type='text' name="tranTimeFm" class="form-control"/>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                        </div>
                                    </td>
                                    <td class="width-10">
                                        <label class="pull-right" title="结束时间：">结束时间</label>
                                    </td>
                                    <td class="width-15">
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="report:banQinWmRepCombine:export">
            ...
            <!-- 表格 -->
            <table id="wmRepCombineTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

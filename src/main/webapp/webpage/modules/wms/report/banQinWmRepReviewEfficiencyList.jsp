...
<head>
    ...
    <%@include file="banQinWmRepReviewEfficiencyList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">验货效率</h3>
        </div>
        <div class="panel-body">
            ...
            <div id="toolbar">
                ...
                <shiro:hasAnyPermissions name="report:banQinWmRepWorkEfficiency:review:export">

...
<head>
    ...
    <%@include file="banQinWmRepOutDailyQueryList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">出库日报表列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="banQinWmRepOutDailyQueryEntity" class="form">
                            ...
                            <table class="table well">
                                ...
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <sys:popSelect url="${ctx}/wms/customer/banQinEbCustomer/grid" title="选择收货人" cssClass="form-control"
                                                       ...
                                                       queryParams="ebcuType" queryParamValues="consigneeType" inputSearchKey="codeAndName">
                                        </sys:popSelect>
                                    </td>
                                    <td class="width-10">
                                    ...
                                    <td class="width-15">
                                        <div class='input-group date' id='createTimeF'>
                                            <input type='text' name="createTimeF" class="form-control"/>
                                ...
                                <tr>
                                    ...
                                    <td class="width-15">
                                        <div class='input-group date' id='createTimeT'>
                                            <input type='text' name="createTimeT" class="form-control"/>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                        </div>
                                    </td>
                                    <td class="width-10">
                                    ...
                                    <td class="width-15">
                                        <form:input path="def5" htmlEscape="false" maxlength="64" class=" form-control"/>
                                    </td>
                                    <ty>
                                        <td class="width-10">
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="report:banQinWmRepOutDailyQuery:export">
            ...
            <!-- 表格 -->
            <table id="banQinWmRepOutDailyQueryTable" data-toolbar="#toolbar" class="text-nowrap"></table>
            <div style="width: 100%; text-align: center;">
                <font size="3"><b><span>订货总数量</span><input id="totalSoQty" style="border:none;" readonly/></b></font>
                <font size="3"><b><span>发货总数量</span><input id="totalShipQty" style="border:none;" readonly/></b></font>
            </div>
        </div>
    </div>
</div>

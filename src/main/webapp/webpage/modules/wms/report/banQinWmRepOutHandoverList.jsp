...
<html>
<head>
    <title>出库交接清单管理</title>
    <meta http-equiv="Content-type" content="text/html; charset=utf-8">
    <meta name="decorator" content="ani"/>
    <%@ include file="/webpage/include/bootstraptable.jsp" %>
    <%@include file="banQinWmRepOutHandoverList.js" %>
</head>
<body>
<div class="hide">
...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">出库交接清单列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="banQinWmSoPackEntity" class="form">
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="report:banQinWmRepOutHandover:export">

...
<head>
    ...
    <%@include file="banQinWmTfHeaderList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">库存转移列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="banQinWmTfHeaderEntity" class="form">
                            <input id="orgId" name="orgId" type="hidden">
                            <table class="table well">
                                <tbody>
                                <tr>
                                    <td class="width-10">
                                        <label class="pull-right" title="转移单号：">转移单号</label>
                                    </td>
                                    <td class="width-15">
                                        <form:input path="tfNo" htmlEscape="false" maxlength="64" class=" form-control"/>
                                    </td>
                                    <td class="width-10">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="inventory:banQinWmTfHeader:add">
                    <a id="add" class="btn btn-primary" onclick="add()"> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="inventory:banQinWmTfHeader:edit">
                    <button id="edit" class="btn btn-primary" disabled onclick="edit()"> 修改</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="inventory:banQinWmTfHeader:del">
                ...
                <shiro:hasPermission name="inventory:banQinWmTfHeader:transfer">
                    <button id="transfer" class="btn btn-primary" disabled onclick="transfer()">执行转移</button>
                </shiro:hasPermission>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <shiro:hasPermission name="inventory:banQinWmAdHeader:printTfOrder">
                            <li><a id="printTfOrder" onclick="printTfOrder()">打印转移单</a></li>
                        </shiro:hasPermission>
                    </ul>
                </div>
                <shiro:hasPermission name="inventory:banQinWmTfHeader:export">
            ...
            <!-- 表格 -->
            <table id="banQinWmTfHeaderTable" data-toolbar="#toolbar" class="text-nowrap"></table>
        </div>
    </div>
</div>
</body>

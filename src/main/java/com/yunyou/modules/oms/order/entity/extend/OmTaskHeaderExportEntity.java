 ...
 * @version 2020-04-07
 */
public class OmTaskHeaderExportEntity extends OmTaskHeaderEntity {

    @Override
    @ExcelField(title = "作业任务号", align = 2, sort = 1)
    public String getTaskNo() {
        return super.getTaskNo();
    }

    @Override
    @ExcelField(title = "任务类型", align = 2, sort = 2, dictType = "OMS_TASK_TYPE")
    public String getTaskType() {
        return super.getTaskType();
    }

    @Override
    @ExcelField(title = "仓库", align = 2, sort = 3)
    public String getWarehouseName() {
        return super.getWarehouseName();
    }

    @Override
    @ExcelField(title = "客户订单号", align = 2, sort = 4)
    ...
    @Override
    @ExcelField(title = "货主", align = 2, sort = 6)
    public String getOwnerName() {
        return super.getOwnerName();
    }

    @Override
    @ExcelField(title = "供应商", align = 2, sort = 7)
    public String getSupplierName() {
        return super.getSupplierName();
    }

    @Override
    @ExcelField(title = "客户", align = 2, sort = 8)
    public String getCustomerName() {
        return super.getCustomerName();
    }

    @Override
    @ExcelField(title = "任务状态", align = 2, sort = 9, dictType = "OMS_TASK_STATUS")
    ...
    @Override
    @ExcelField(title = "任务批次", align = 2, sort = 14)

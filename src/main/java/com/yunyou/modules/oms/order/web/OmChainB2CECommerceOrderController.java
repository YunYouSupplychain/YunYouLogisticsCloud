 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/oms/order/omChainB2CECommerceOrder")
public class OmChainB2CECommerceOrderController extends BaseController {
    @Autowired
     ...
     * B2C电商订单列表页面
     */
    @RequiresPermissions("order:omChainB2CECommerceOrder:list")
    @RequestMapping(value = {"list", ""})
    public String list() {
        return "modules/oms/order/omChainB2CECommerceOrderList";
    }
    ...
    public Map<String, Object> data(OmChainHeaderEntity omChainHeaderEntity, HttpServletRequest request, HttpServletResponse response) {
        ...
        omChainHeaderEntity.setBusinessOrderTypeList(
                Lists.newArrayList(BusinessOrderType.B2C_E_COMMERCE_ASN.getBusinessType(), BusinessOrderType.B2C_E_COMMERCE_SO.getBusinessType()));
     ...
     * 查看，增加，编辑B2C电商订单表单页面
     */
    @RequiresPermissions(value = {"order:omChainB2CECommerceOrder:view", "order:omChainB2CECommerceOrder:add", "order:omChainB2CECommerceOrder:edit"}, logical = Logical.OR)
    ...
    public String form(OmChainHeaderEntity omChainHeaderEntity, Model model) {
        ...
        return "modules/oms/order/omChainB2CECommerceOrderForm";
    }
     ...
     */
    @ResponseBody
    @RequiresPermissions(value = {"order:omChainB2CECommerceOrder:add", "order:omChainB2CECommerceOrder:edit"}, logical = Logical.OR)
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainB2CECommerceOrder:del")
    ...
    public AjaxJson exportFile(OmChainHeaderEntity entity, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            j.setSuccess(false);
            j.setMsg("导出B2C电商订单记录失败！失败信息：" + e.getMessage());
        }
        return j;
    }
     ...
     * 导入Excel数据
     */
    @RequiresPermissions("order:omChainB2CECommerceOrder:import")
    ...
    public String importFileTemplate(HttpServletResponse response, RedirectAttributes redirectAttributes) {
        try {
            new ExportExcel("", OmChainImportEntity.class, 2).setDataList(Lists.newArrayList()).write(response, "B2C电商订单导入模板.xlsx").dispose();
            return null;
        } catch (Exception e) {
            addMessage(redirectAttributes, "导入模板下载失败！失败信息：" + e.getMessage());
        }
        return "redirect:" + Global.getAdminPath() + "/oms/order/omChainB2CECommerceOrder/?repage";
    }
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainB2CECommerceOrder:audit")
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainB2CECommerceOrder:cancelAudit")
     ...
     */
    @RequiresPermissions("order:omChainB2CECommerceOrder:cancel")
    @ResponseBody
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainB2CECommerceOrder:intercept")

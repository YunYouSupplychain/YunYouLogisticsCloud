 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/oms/order/omChainFABDistributionOrder")
public class OmChainFABDistributionOrderController extends BaseController {
    @Autowired
     ...
     * 餐饮配送订单列表页面
     */
    @RequiresPermissions("order:omChainFABDistributionOrder:list")
    @RequestMapping(value = {"list", ""})
    public String list() {
        return "modules/oms/order/omChainFABDistributionOrderList";
    }
    ...
    public Map<String, Object> data(OmChainHeaderEntity omChainHeaderEntity, HttpServletRequest request, HttpServletResponse response) {
        ...
        omChainHeaderEntity.setBusinessOrderTypeList(
                Lists.newArrayList(BusinessOrderType.FAB_DC_ASN.getBusinessType(), BusinessOrderType.FAB_DC_SO.getBusinessType(),
                        BusinessOrderType.FAB_WMS_ASN.getBusinessType(), BusinessOrderType.FAB_WMS_SO.getBusinessType()));
     ...
     * 查看，增加，编辑餐饮配送订单表单页面
     */
    @RequiresPermissions(value = {"order:omChainFABDistributionOrder:view", "order:omChainFABDistributionOrder:add", "order:omChainFABDistributionOrder:edit"}, logical = Logical.OR)
    ...
    public String form(OmChainHeaderEntity omChainHeaderEntity, Model model) {
        ...
        return "modules/oms/order/omChainFABDistributionOrderForm";
    }
     ...
     */
    @ResponseBody
    @RequiresPermissions(value = {"order:omChainFABDistributionOrder:add", "order:omChainFABDistributionOrder:edit"}, logical = Logical.OR)
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainFABDistributionOrder:del")
    ...
    public AjaxJson exportFile(OmChainHeaderEntity entity, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            j.setSuccess(false);
            j.setMsg("导出餐饮配送订单记录失败！失败信息：" + e.getMessage());
        }
        return j;
    }
     ...
     * 导入Excel数据
     */
    @RequiresPermissions("order:omChainFABDistributionOrder:import")
    ...
    public String importFileTemplate(HttpServletResponse response, RedirectAttributes redirectAttributes) {
        try {
            new ExportExcel("", OmChainImportEntity.class, 2).setDataList(Lists.newArrayList()).write(response, "餐饮配送订单导入模板.xlsx").dispose();
            return null;
        } catch (Exception e) {
            addMessage(redirectAttributes, "导入模板下载失败！失败信息：" + e.getMessage());
        }
        return "redirect:" + Global.getAdminPath() + "/oms/order/omChainFABDistributionOrder/?repage";
    }
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainFABDistributionOrder:audit")
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainFABDistributionOrder:cancelAudit")
     ...
     */
    @RequiresPermissions("order:omChainFABDistributionOrder:cancel")
    @ResponseBody
     ...
     */
    @ResponseBody
    @RequiresPermissions("order:omChainFABDistributionOrder:intercept")

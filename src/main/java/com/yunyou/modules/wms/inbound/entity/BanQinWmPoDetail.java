 ...
 * @version 2019-01-26
 */
public class BanQinWmPoDetail extends DataEntity<BanQinWmPoDetail> {
	...
	private String headId;		// 采购单ID
	
	public BanQinWmPoDetail() {
		super();
		this.recVer = 0;
	}

	public BanQinWmPoDetail(String id){
		super(id);
	}
	...
	@ExcelField(title="采购数EA", align=2, sort=11)
	...
	@ExcelField(title="预收货数EA", align=2, sort=12)
	...
	@ExcelField(title="收货数量EA", align=2, sort=13)
	...
	@ExcelField(title="批次属性01(生产日期)", align=2, sort=15)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="批次属性02(失效日期)", align=2, sort=16)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="批次属性03(入库日期)", align=2, sort=17)
	...
	@ExcelField(title="批次属性04(品质)", dictType="", align=2, sort=18)
	...
	@ExcelField(title="批次属性05", align=2, sort=19)
	...
	@ExcelField(title="批次属性06", align=2, sort=20)
	...
	@ExcelField(title="批次属性07", align=2, sort=21)
	...
	@ExcelField(title="批次属性08", align=2, sort=22)
	...
	@ExcelField(title="批次属性09", align=2, sort=23)
	...
	@ExcelField(title="批次属性10", align=2, sort=24)
	...
	@ExcelField(title="批次属性11", align=2, sort=25)
	...
	@ExcelField(title="批次属性12", align=2, sort=26)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="EDI发送时间", align=2, sort=27)
	...
	@ExcelField(title="EDI是否已发送", dictType="", align=2, sort=28)
	...
	@ExcelField(title="分公司", align=2, sort=47)
	...
	@ExcelField(title="采购单ID", align=2, sort=48)

 ...
 * @version 2019-08-20
 */
public class BanQinWmKitResultDetail extends DataEntity<BanQinWmKitResultDetail> {
	...
	private Double qtyCompleteEa = 0D;		// 实际加工数EA
	private String kitLoc;		// 加工台
	private String kitTraceId;		// 加工跟踪号
	private String subSelectCode;		// 子件指定规则
	private String reserveCode;		// 上架库位指定规则(上架时计算库位)
	...
	public BanQinWmKitResultDetail() {
		super();
		this.recVer = 0;
	}

	public BanQinWmKitResultDetail(String id){
		super(id);
	}
	...
	@ExcelField(title="加工操作行号", align=2, sort=4)
	...
	@ExcelField(title="状态", dictType="SYS_WM_KIT_STATUS", align=2, sort=5)
	...
	@ExcelField(title="父件编码", align=2, sort=7)
	...
	@ExcelField(title="计划加工数EA", align=2, sort=10)
	...
	@ExcelField(title="实际加工数EA", align=2, sort=11)
	public Double getQtyCompleteEa() {
		return qtyCompleteEa;
	}

	public void setQtyCompleteEa(Double qtyCompleteEa) {
		this.qtyCompleteEa = qtyCompleteEa;
	}
	
	@ExcelField(title="加工台", align=2, sort=12)
	...
	@ExcelField(title="加工跟踪号", align=2, sort=13)
	public String getKitTraceId() {
		return kitTraceId;
	}

	public void setKitTraceId(String kitTraceId) {
		this.kitTraceId = kitTraceId;
	}
	
	@ExcelField(title="子件指定规则", align=2, sort=14)
	public String getSubSelectCode() {
		return subSelectCode;
	}

	public void setSubSelectCode(String subSelectCode) {
		this.subSelectCode = subSelectCode;
	}
	
	@ExcelField(title="上架库位指定规则(上架时计算库位)", align=2, sort=15)
	...
	@ExcelField(title="上架规则", align=2, sort=16)
	...
	@ExcelField(title="上架任务ID", align=2, sort=17)
	...
	@ExcelField(title="批次号", align=2, sort=18)
	...
	@ExcelField(title="批次属性1(生产日期)", align=2, sort=19)
	...
	@JsonFormat(pattern = "yyyy-MM-dd")
	@ExcelField(title="批次属性2(失效日期)", align=2, sort=20)
	...
	@JsonFormat(pattern = "yyyy-MM-dd")
	@ExcelField(title="批次属性3(入库日期)", align=2, sort=21)
	...
	@ExcelField(title="批次属性4", align=2, sort=22)
	...
	@ExcelField(title="批次属性5", align=2, sort=23)
	...
	@ExcelField(title="批次属性6", align=2, sort=24)
	...
	@ExcelField(title="批次属性7", align=2, sort=25)
	...
	@ExcelField(title="批次属性8", align=2, sort=26)
	...
	@ExcelField(title="批次属性9", align=2, sort=27)
	...
	@ExcelField(title="批次属性10", align=2, sort=28)
	...
	@ExcelField(title="批次属性11", align=2, sort=29)
	...
	@ExcelField(title="批次属性12", align=2, sort=30)
	...
	@ExcelField(title="机构ID", align=2, sort=44)

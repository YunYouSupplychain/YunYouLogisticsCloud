 ...
 * @version 2019-01-28
 */
public class BanQinWmTfHeader extends DataEntity<BanQinWmTfHeader> {
	...
	private String tfOp;		// 转移操作人
	private Date tfTime;		// 转移时间
	...
	public BanQinWmTfHeader() {
		super();
		this.recVer = 0;
	}

	public BanQinWmTfHeader(String id){
		super(id);
	}
	...
	@ExcelField(title="转移操作人", align=2, sort=11)
	public String getTfOp() {
		return tfOp;
	}

	public void setTfOp(String tfOp) {
		this.tfOp = tfOp;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="转移时间", align=2, sort=12)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="EDI发送时间", align=2, sort=13)
	...
	@ExcelField(title="EDI是否已发送", align=2, sort=14)

 ...
 * @version 2020-04-07
 */
public class BanQinWmHoldExportEntity extends BanQinWmHoldEntity {
    ...
    @Override
    @ExcelField(title = "冻结方式", align = 2, sort = 2, dictType = "SYS_WM_HOLD_TYPE")
    ...
    @Override
    @ExcelField(title = "冻结原因", align = 2, sort = 10, dictType = "SYS_WM_HOLD_REASON")
    ...
    @Override
    @ExcelField(title = "冻结人", align = 2, sort = 15)
    ...
    @ExcelField(title = "冻结时间", align = 2, sort = 16)

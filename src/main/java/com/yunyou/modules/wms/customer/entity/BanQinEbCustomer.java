package com.yunyou.modules.wms.customer.entity;
 ...
 * @version 2019-01-25
 */
public class BanQinEbCustomer extends DataEntity<BanQinEbCustomer> {
	...
	private String ebcuEbflId;		// 客户评  估审计
	private String ebcuCustomerStatus;		// 客户状态:ENABLE可用,DISABLE不可用,ADD新增
	...
	private String ebcuSubstr7;		// 预留字段
	private String ebcuSubstr8;		// 预留字段
	...
	public BanQinEbCustomer() {
		super();
		this.recVer = 0;
	}

	public BanQinEbCustomer(String id){
		super(id);
	}
	...
	@ExcelField(title="行业类型", align=2, sort=3)
	...
	@ExcelField(title="分公司", align=2, sort=48)
	...
	@ExcelField(title="客户类型", align=2, sort=66)

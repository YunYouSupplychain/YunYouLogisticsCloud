 ...
 */
@MyBatisMapper
public interface BanQinCdRulePaHeaderMapper extends BaseMapper<BanQinCdRulePaHeader> {
    List<BanQinCdRulePaHeader> findPage(BanQinCdRulePaHeader cdRulePaHeader);

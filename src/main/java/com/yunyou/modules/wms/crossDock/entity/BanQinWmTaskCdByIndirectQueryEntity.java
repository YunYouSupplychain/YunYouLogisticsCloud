 ...
 * @version 2020-02-14
 */
public class BanQinWmTaskCdByIndirectQueryEntity {
    ...
    public String getIndirectStatus() {
        return indirectStatus;
    }

    public void setIndirectStatus(String indirectStatus) {
        this.indirectStatus = indirectStatus;
    }
    ...
    public Long getQtyPlanUom() {
        return qtyPlanUom;
    }

    public void setQtyPlanUom(Long qtyPlanUom) {

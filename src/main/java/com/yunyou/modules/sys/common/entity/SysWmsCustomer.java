 ...
 * 客户Entity
 */
public class SysWmsCustomer extends DataEntity<SysWmsCustomer> {
    ...
    public SysWmsCustomer() {
        super();
        this.recVer = 0;
    }

    public SysWmsCustomer(String id) {
        super(id);
    }

    public SysWmsCustomer(String id, String dataSet) {
        super(id);

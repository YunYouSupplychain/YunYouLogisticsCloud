 ...
 * 包装明细Entity
 */
public class SysOmsPackageRelation extends DataEntity<SysOmsPackageRelation> {
    ...
    public SysOmsPackageRelation(String id) {
        super(id);
    }

    public SysOmsPackageRelation(String id, String dataSet) {
        super(id);
    ...
    @ExcelField(title = "时区", align = 2, sort = 24)

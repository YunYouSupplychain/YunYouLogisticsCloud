 ...
 * 运输人员信息Entity
 */
public class SysTmsDriver extends DataEntity<SysTmsDriver> {
	...
	private List<SysTmsDriverQualification> driverQualificationList = Lists.newArrayList();;
	...
	public SysTmsDriver(String id){
		super(id);
	}

	public SysTmsDriver(String code, String dataSet) {
		this.code = code;
		this.dataSet = dataSet;
	}

	public SysTmsDriver(String id, String code, String dataSet) {
		super(id);
		this.code = code;
		this.dataSet = dataSet;
	}
	...
	@ExcelField(title="准驾车型", dictType="TMS_CAR_TYPE", align=2, sort=19)
	...
	public List<SysTmsDriverQualification> getDriverQualificationList() {
		return driverQualificationList;
	}

	public void setDriverQualificationList(List<SysTmsDriverQualification> driverQualificationList) {
		this.driverQualificationList = driverQualificationList;
	}

 ...
 * 商品信息Entity
 */
public class SysTmsItem extends DataEntity<SysTmsItem> {
    ...
    private String def4;
    private String def5;
    private List<SysTmsItemBarcode> barcodeList = Lists.newArrayList();

    public SysTmsItem() {
        super();
    }

    public SysTmsItem(String id) {
        super(id);
    }

    public SysTmsItem(String ownerCode, String skuCode, String dataSet) {
    ...
    public List<SysTmsItemBarcode> getBarcodeList() {
        return barcodeList;
    }

    public void setBarcodeList(List<SysTmsItemBarcode> barcodeList) {

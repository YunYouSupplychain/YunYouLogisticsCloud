 ...
 * 商品拣货位Entity
 */
public class SysCommonSkuLoc extends DataEntity<SysCommonSkuLoc> {
    ...
    public SysCommonSkuLoc() {
        super();
    }

    public SysCommonSkuLoc(String id) {
        super(id);
    }

    public SysCommonSkuLoc(String id, String headerId, String dataSet) {
        super(id);

 ...
 * 车辆资质信息Entity
 */
public class SysTmsVehicleQualification extends DataEntity<SysTmsVehicleQualification> {
    ...
    public SysTmsVehicleQualification() {
        super();
    }

    public SysTmsVehicleQualification(String id) {
        super(id);
    }

    public SysTmsVehicleQualification(String carNo, String dataSet) {
        this.carNo = carNo;
        this.dataSet = dataSet;
    }

    public SysTmsVehicleQualification(String carNo, String qualificationCode, String dataSet) {
        this.carNo = carNo;

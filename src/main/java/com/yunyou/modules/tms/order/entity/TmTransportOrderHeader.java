 ...
 * @version 2020-03-04
 */
public class TmTransportOrderHeader extends DataEntity<TmTransportOrderHeader> {
    ...
    public TmTransportOrderHeader() {
    }

    public TmTransportOrderHeader(String id) {
        super(id);
    }

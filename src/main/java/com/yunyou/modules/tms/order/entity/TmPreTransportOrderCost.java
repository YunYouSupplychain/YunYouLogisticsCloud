 ...
 * @version 2020-03-04
 */
public class TmPreTransportOrderCost extends DataEntity<TmPreTransportOrderCost> {
	...
	public TmPreTransportOrderCost() {
		super();
	}

	public TmPreTransportOrderCost(String id){
		super(id);
	}

	public TmPreTransportOrderCost(String transportNo, String orgId) {

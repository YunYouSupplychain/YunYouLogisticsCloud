...
public class TmRepairOrderOutboundInfo extends DataEntity<TmRepairOrderOutboundInfo> {
    ...
    public TmRepairOrderOutboundInfo() {
    }

    public TmRepairOrderOutboundInfo(String id) {
        super(id);
    }

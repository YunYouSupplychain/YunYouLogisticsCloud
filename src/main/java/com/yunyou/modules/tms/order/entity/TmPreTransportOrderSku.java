 ...
 * @version 2020-03-04
 */
public class TmPreTransportOrderSku extends DataEntity<TmPreTransportOrderSku> {
    ...
    private String def6; // 包装规格名称
    private String def7; // 包装单位
    private String def8;
    private String def9;
    private String def10;

    public TmPreTransportOrderSku() {
        super();
    }

    public TmPreTransportOrderSku(String id) {
        super(id);
    }

    public TmPreTransportOrderSku(String transportNo, String orgId) {

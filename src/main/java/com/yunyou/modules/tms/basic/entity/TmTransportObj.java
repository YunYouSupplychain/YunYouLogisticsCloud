 ...
 * @version 2020-02-20
 */
public class TmTransportObj extends DataEntity<TmTransportObj> {
	...
	public TmTransportObj() {
		super();
	}

	public TmTransportObj(String id){
		super(id);
	}

	public TmTransportObj(String transportObjCode, String orgId) {
	...
	@ExcelField(title="机构ID", align=2, sort=24)

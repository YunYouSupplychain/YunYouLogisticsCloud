 ...
 * @version 2020-02-20
 */
public class TmVehicle extends DataEntity<TmVehicle> {
	...
	public TmVehicle(String id){
		super(id);
	}

	public TmVehicle(String carNo, String orgId) {
		this.carNo = carNo;
		this.orgId = orgId;
	}
	...
	@ExcelField(title="机构ID", align=2, sort=58)

...
import com.yunyou.modules.bms.basic.mapper.BmsContractStorageSteppedPriceMapper;
...
public class BmsContractStorageSteppedPriceService extends CrudService<BmsContractStorageSteppedPriceMapper, BmsContractStorageSteppedPrice> {

    /**
     * 描述：根据外键ID查询阶梯价格
     */
    public List<BmsContractStorageSteppedPrice> findByFkId(String fkId) {

...
public class BmsTransportPriceExportTemplate implements Serializable {
    private static final long serialVersionUID = -1233359173760394006L;

    @ExcelField(title = "起点编码", type = 1)
    private String startPlaceCode;
    @ExcelField(title = "起点名称", type = 1)
    private String startPlaceName;
    @ExcelField(title = "终点编码", type = 1)
    private String endPlaceCode;
    @ExcelField(title = "终点名称", type = 1)
    private String endPlaceName;
    @ExcelField(title = "车型编码", type = 1)
    private String carTypeCode;
    @ExcelField(title = "车型", type = 1)
    private String carType;
    @ExcelField(title = "区域编码", type = 1)
